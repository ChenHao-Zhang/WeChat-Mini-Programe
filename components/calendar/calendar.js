...
methods: {
  ...
  popTest: function(e){
    let festival = {'11':'元旦节','38':'妇女节','312':'植树节','45':'清明节','51':'劳动节','61':'儿童节','101':'国庆节','1126':'感恩节'}
    let month = this.data.currentMonth
    let day = e.target.id
    console.log(festival[month+day])
    if(festival[month+day]!=null){
      wx.showToast({
        title: festival[month+day],
        icon: 'none',
        duration: 2000     
      })
    }
